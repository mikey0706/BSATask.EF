...
namespace BSATask.WebAPI.Controllers
{
    ...
    public class TeamsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CreateProject([FromBody] TeamCreateModel team)
        {
            await _teamCreateService.CreateTeam(_mapper.Map<TeamCreateUpdateDto>(team));
            return Ok();
        }
        ...
        {
            await _teamCreateService.UpdateTeam(id, _mapper.Map<TeamCreateUpdateDto>(payload));
            return Ok();
        }
